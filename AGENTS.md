...
After changes, run the unit tests with Node available, the skill validator, and the plugin validator. Simulate all six hook events with JSON input. Keep user-facing language nontechnical and efficiency-first; do not skip a required gate.
