...
| Scope fidelity | Final standalone scope gate | `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\qa\final-scope-fidelity.ps1 ...` | exit 0, evidence/Linear/GitHub/scope assertions pass | `task-16-linear-rollup.md` |
...
- Todo 16: `task-16-linear-comments.json`, `task-16-linear-rollup.md`, `task-16-formatting.txt` - Linear governance/evidence handoff proof, final scope-fidelity gate, and focused formatting/syntax checks.

## Adversarial Self-Check

- stale_state: this rollup cites current evidence files and Todo 16 validates live git, GitHub metadata, and Linear proof.
