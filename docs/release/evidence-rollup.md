...
- Todo 16: `task-16-linear-comments.json`, `task-16-code-review.txt`, `task-16-manual-qa-matrix.md`, `task-16-notepad.md`, `task-16-linear-rollup.md`, `task-16-formatting.txt` - Linear governance/evidence handoff proof, review bundle, final scope-fidelity gate, remediation notes, and focused formatting/syntax checks.
