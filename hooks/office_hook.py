...
def source_free_intake_context(prompt: str) -> str:
    ...
    return (
        ...
        "do not reconstruct or paraphrase them from skill text. Do not emit a preamble, plan, "
        "skill announcement, or separate progress message.\n"
        "Any required Windows PowerShell skill read must use Get-Content -Raw -Encoding UTF8. "
        "Never rely on default Windows PowerShell decoding. If non-ASCII text looks garbled, "
        "reread it as UTF-8 before replying.\n\n"
