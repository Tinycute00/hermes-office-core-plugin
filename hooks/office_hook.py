...
def source_free_intake_context(prompt: str) -> str:
    ...
    return (
        ...
        "tool call or skill load. If the host requires a skill-use announcement, that exact "
        "line must be the entire announcement. Emit no other preamble, plan, progress, or "
